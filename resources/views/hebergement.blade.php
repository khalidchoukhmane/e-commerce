                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card pricing hosting-rate border-0 rounded overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary mt-4">Commander Basic+</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card pricing hosting-rate best-plan border-0 rounded">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary mt-4">Commander Entreprise</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card pricing hosting-rate border-0 rounded overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary-perfermance mt-4">Commander Performance</a>
								<a href="javascript:void(0)" class="btn btn-primary mt-4">Commander Performance+</a>
                            </div>
                        </div>
                    </div><!--end col-->
