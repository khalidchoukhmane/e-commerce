                    ...
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                            ...
                            <nav class="bradcaump-content">
                              ...
                              <span class="breadcrumb_item active">Ordinateurs Portables</span>
                            </nav>
                        </div>
                    </div>
                </div>
        				...
        				<div class="tab__container">
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
	        					<div class="row">
									...
									@foreach ($ordinateures_portables as $ordinateure_portable)
									@if($ordinateure_portable->type != 'Hot')
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center">
											<h4><a href="single-product">{{ $ordinateure_portable->libelle }}</a></h4>
											<ul class="prize d-flex">
												<li>{{ $ordinateure_portable->new_price }}</li>
												<li class="old_prize">{{ $ordinateure_portable->previous_price }}</li>
											</ul>
											<div class="action">
	        				...
	        				<div class="shop-grid tab-pane fade" id="nav-list" role="tabpanel">
	        					<div class="list__view__wrapper">
	        						...
	        						<div class="list__view">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product">{{ $ordinateure_portable->libelle }}</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        								...
	        								<ul class="prize__box">
	        									<li>{{ $ordinateure_portable->new_price }}</li>
	        									<li class="old__prize">{{ $ordinateure_portable->previous_price }}</li>
	        								</ul>
