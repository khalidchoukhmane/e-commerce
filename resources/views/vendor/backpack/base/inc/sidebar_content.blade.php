...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('dashboard') }}" style="color:black;"><i class="la la-home nav-icon"></i> {{ trans('backpack::base.dashboard') }}</a></li>
{{-- <li class='nav-item'><a class='nav-link' href='{{ backpack_url('element') }}' style="color:black;"><i class='la la-cloud-upload-alt nav-icon' style="color:black;"></i> Eléments de Menu </a></li> --}}
