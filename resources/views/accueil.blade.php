						...
						@if($imprimant->type != "Hot")
							<div class="single__product">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="#"><img src="{{ $imprimant->image }}" alt="product image"></a>
											<a class="second__img animation1" href="#"><img src="{{ $imprimant->image }}" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">PLUS VENDU</span>
											</div>
										</div>
										<div class="product__content content--center content--center">
											<h4><a href="#">{{ $imprimant->libelle  }}</a></h4>
											<ul class="prize d-flex">
